/* This file is generated. Do not edit!
   ...
   flags: scripts/generate-wrapper.py --include include/xkbcommon/xkbcommon.h --include include/xkbcommon/xkbcommon-compose.h --sys-include <xkbcommon/xkbcommon.h> --sys-include <xkbcommon/xkbcommon-compose.h> --soname libxkbcommon.so.0 --init-name xkbcommon --output-header include_gen/xkbcommon-so_wrap.h --output-implementation src_gen/xkbcommon-so_wrap.c --ignore-other --include-dir include
*/
#include <stdint.h>
...
void (*xkb_context_set_log_fn_dylibloader_wrapper_xkbcommon)(struct xkb_context *, void (*)(struct xkb_context *context, enum xkb_log_level level, const char *format, va_list args));
struct xkb_keymap *(*xkb_keymap_new_from_names_dylibloader_wrapper_xkbcommon)(struct xkb_context *, const struct xkb_rule_names *, enum xkb_keymap_compile_flags);
